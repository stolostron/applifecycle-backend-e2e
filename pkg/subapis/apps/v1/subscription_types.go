...
import (
	...
	chnv1alpha1 "github.com/stolostron/applifecycle-backend-e2e/pkg/chnapis/apps/v1"
	plrv1alpha1 "github.com/stolostron/applifecycle-backend-e2e/pkg/subapis/apps/placementrule/v1"
)
