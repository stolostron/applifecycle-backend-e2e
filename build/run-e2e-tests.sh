...
setup_subscription_operator(){
    ...
    sed -i -e "s|image: .*$|image: quay.io/stolostron/multicluster-operators-subscription:community-$COMPONENT_VERSION|" multicloud-operators-subscription/deploy/standalone/operator.yaml
